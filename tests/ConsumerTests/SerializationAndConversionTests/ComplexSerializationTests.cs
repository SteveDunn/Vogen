...
public class ComplexSerializationTests
{
    public class Complex
    {
        ...
        public Vogen.IntegrationTests.TestTypes.ClassVos.SystemTextJsonDateTimeVo Vogen_IntegrationTests_TestTypes_ClassVos_SystemTextJsonDateTimeVo { get; set; } = Vogen.IntegrationTests.TestTypes.ClassVos.SystemTextJsonDateTimeVo.From(new DateTime(2020, 12, 13, 23, 59, 59, 999));
        ...
        public Vogen.IntegrationTests.TestTypes.RecordClassVos.SystemTextJsonDateTimeVo Vogen_IntegrationTests_TestTypes_RecordClassVos_SystemTextJsonDateTimeVo { get; set; } = Vogen.IntegrationTests.TestTypes.RecordClassVos.SystemTextJsonDateTimeVo.From(new DateTime(2020, 12, 13, 23, 59, 59, 999));
        ...
        public Vogen.IntegrationTests.TestTypes.RecordClassVos.SystemTextJsonStringVo Vogen_IntegrationTests_TestTypes_RecordClassVos_SystemTextJsonStringVo { get; set; } = Vogen.IntegrationTests.TestTypes.RecordClassVos.SystemTextJsonStringVo.From("8");
        ...
        public Vogen.IntegrationTests.TestTypes.StructVos.SystemTextJsonDateTimeVo Vogen_IntegrationTests_TestTypes_StructVos_SystemTextJsonDateTimeVo { get; set; } = Vogen.IntegrationTests.TestTypes.StructVos.SystemTextJsonDateTimeVo.From(new DateTime(2020, 12, 13, 23, 59, 59, 999));
        ...
        public Vogen.IntegrationTests.TestTypes.RecordStructVos.SystemTextJsonDateTimeVo Vogen_IntegrationTests_TestTypes_RecordStructVos_SystemTextJsonDateTimeVo { get; set; } = Vogen.IntegrationTests.TestTypes.RecordStructVos.SystemTextJsonDateTimeVo.From(new DateTime(2020, 12, 13, 23, 59, 59, 999));
    ...
    public void CanSerializeAndDeserialize()
    {
        ...
        deserialized.Vogen_IntegrationTests_TestTypes_RecordClassVos_SystemTextJsonDateTimeVo.Value.Should().Be(new DateTime(2020, 12, 13, 23, 59, 59, 999));
        ...
        deserialized.Vogen_IntegrationTests_TestTypes_RecordClassVos_SystemTextJsonStringVo.Value.Should().Be("8");
