...
For detailed information, see [IConvertible](IConvertible.md)                                                                                  
<note>
IConvertible is automatically hoisted when the underlying primitive implements it.
</note>
...
- [Casting Operators](Casting.md) – Configuring cast operators
