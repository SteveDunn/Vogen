...
public class VogenDefaultsAttribute : Attribute
{
    ...
    /// <param name="nullPropagatingToPrimitiveCasts">Controls whether the <b>explicit</b> to-primitive cast on reference-type value objects propagates <see langword="null"/>
