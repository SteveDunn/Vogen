        ...
        class VOTYPETypeConverter : global::System.ComponentModel.TypeConverter
        {
            ...
            public override object ConvertFrom(global::System.ComponentModel.ITypeDescriptorContext context, global::System.Globalization.CultureInfo culture, object value)
            {
                return value switch
                {
                    string stringValue when !string.IsNullOrEmpty(stringValue) && global::System.DateTime.TryParseExact(stringValue, "O", global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.RoundtripKind, out var result) => new VOTYPE(result),
