...
__NORMAL__                return __DeserializeSystemTextJson(global::System.Text.Json.JsonSerializer.Deserialize(ref reader, (global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::System.Decimal>)options.GetTypeInfo(typeof(global::System.Decimal))));
#else
__NORMAL__                return __DeserializeSystemTextJson(reader.GetDecimal());
#endif
__STRING__                return __DeserializeSystemTextJson(global::System.Decimal.Parse(reader.GetString(), global::System.Globalization.NumberStyles.Any, global::System.Globalization.CultureInfo.InvariantCulture));
            }
...
#endif
            private static VOTYPE __DeserializeSystemTextJson(VOUNDERLYINGTYPE value)
            {
                try
                {
