...
/// </summary>
public class UserProvidedTryFormatMethods : IEnumerable<IMethodSymbol>
{
    private readonly List<IMethodSymbol> _userMethods;

    public UserProvidedTryFormatMethods(List<IMethodSymbol> userMethods) => _userMethods = userMethods;
