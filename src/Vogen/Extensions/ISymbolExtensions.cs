...
namespace Analyzer.Utilities.Extensions
{
    internal static class ISymbolExtensions
    {
        ...
        public static bool IsPropertyWithBackingField(this ISymbol? symbol, out IFieldSymbol? backingField)
        {
        ...
        /// <paramref name="attribute"/>; otherwise <see langword="false"/>.
        /// </returns>
        public static bool HasDerivedTypeAttribute(this ITypeSymbol symbol, INamedTypeSymbol? attribute)
        {
            if (attribute == null)
            {
                return false;
        ...
        /// <paramref name="attribute"/>; otherwise <see langword="false"/>.
        /// </returns>
        public static bool HasDerivedMethodAttribute(this IMethodSymbol symbol, INamedTypeSymbol? attribute)
        {
            if (attribute == null)
            {
                return false;
