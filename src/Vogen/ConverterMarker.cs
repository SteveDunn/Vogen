...
/// <summary>
/// Represents an instance of a marker class attribute, e.g. `EfCoreConverterAttribute` or a `MemoryPackageConverterAttribute`.
/// </summary>
...
internal record ConverterMarker(
    ConverterMarkerKind Kind,
